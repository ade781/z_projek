        ...
        <div style={styles.container}>
            ...
            <div style={styles.contentWrapper}>
                ...
                <h1 style={styles.title}>
                    <span style={styles.titleMain}>Edit Composition</span>
                ...
                <form onSubmit={updateNote} style={styles.form}>
                    ...
                    <div style={styles.formGroup}>
                        <label style={styles.label}>
                            <span style={styles.labelText}>Movement</span>
                            <select
                                value={kategori}
                    ...
                    <div style={styles.formGroup}>
                        <label style={styles.label}>
                            <span style={styles.labelText}>Musical Notes</span>
                            <textarea
                    ...
                    <button type="submit" style={styles.submitButton}>
                        <span style={styles.buttonText}>Update Sonata</span>
