                ...
                <div className="p-6">
                    ...
                    <div className="mb-6">
                        ...
                        <ul className="space-y-2 pl-7">
                            ...
                            {misi.min_reputasi > 0 && (
                                <li className="flex items-center">
                                    <svg className="w-4 h-4 mr-2 text-amber-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6l4 2" />
                                    </svg>
                                    <span>Minimum reputasi {misi.min_reputasi}</span>
                                </li>
                            )}
                        </ul>
                    </div>
