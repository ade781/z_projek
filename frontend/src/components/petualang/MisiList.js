              ...
              <div className="flex flex-wrap gap-2">
                {["semua", "belum diambil", "aktif", "selesai"].map((status) => (
                  <button
                    ...
                    className={`px-3 py-1 rounded-full text-sm font-medium transition-all ${filterStatus === status
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredMisi.map((item) => (
              <div
                ...
                className={`bg-gray-800 rounded-lg overflow-hidden border-2 transition-all duration-300 transform ${hoveredCard === item.id_misi
